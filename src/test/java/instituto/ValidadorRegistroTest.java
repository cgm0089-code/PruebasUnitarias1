...
public class ValidadorRegistroTest {
    ...
    public void testNombreValido() {
        ...
        boolean resultado = validador.validarNombre("Carmen");
    ...
    @Test
    @DisplayName("Reto 3: Una contraseña de menos de 8 caracteres debe ser rechazada")
    ...
    // Reto 5: Edad límite
    @Test
    @DisplayName("Reto 5: Un usuario de 16 años debe ser aceptado")
    public void testEdadLimite() {
        boolean resultado = validador.validarEdad(16);
        assertTrue(resultado, "Error: El sistema rechazó un usuario de 16 años");
    }
}
